...
namespace AutoVersion{
	...
	static const long REVISION  = 7574;
	
	//Miscellaneous Version Types
	static const long BUILDS_COUNT  = 918;
	#define RC_FILEVERSION 1,5,16,7574
	#define RC_FILEVERSION_STRING "1, 5, 16, 7574\0"
	static const char FULLVERSION_STRING [] = "1.5.16.7574";
